...
export const PARTNERS = [
  { name: 'Phương Trang', color: 'text-brand' },
  { name: 'Hoàng Long', color: 'text-forest' },
  { name: 'Thành Bưởi', color: 'text-brand' },
  { name: 'Kumho Samco', color: 'text-forest' },
  { name: 'Sao Việt', color: 'text-brand' },
  { name: 'Việt Tân Phát', color: 'text-forest' },
];
