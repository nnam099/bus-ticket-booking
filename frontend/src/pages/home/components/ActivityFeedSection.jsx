        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {WHY_CARDS.map((card) => (
            ...
            >
              ...
              <div className={`w-20 h-20 rounded-2xl flex items-center justify-center text-4xl mb-6 shadow-sm transition-transform duration-500 group-hover:scale-110 group-hover:rotate-3 ${card.bg} dark:bg-slate-700 border border-white/50 dark:border-slate-600`}>
                {card.emoji}
              </div>
